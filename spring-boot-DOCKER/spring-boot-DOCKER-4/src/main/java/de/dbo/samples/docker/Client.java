...
import static de.dbo.samples.docker.ClientPrint.*;
...
public class Client  {
    ...
    public void connectToDockerServer() throws Exception {
	...
	LOG.info("Configuration: " + printConfig(config));
        ...
        LOG.info("found {} containers: " + printContainers(containers) , containers.size() );
