...
/**
 * Image creation and consistency verification with composer-file.
 * 
...
public class ImageCreationTest extends TestAbstraction {
    ...
    public void t00_cleanDocker() throws Exception {
        ...
        commander.removeDockerResources( /* but not */ "ddev");
    }
    ...
    public void t11_checkCompooserImageReferences() throws Exception {
        ...
        composer.assertThatComposerImagesCoveredByImageSources(images);
    }
