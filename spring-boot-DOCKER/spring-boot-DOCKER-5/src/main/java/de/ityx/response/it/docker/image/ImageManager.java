...
import static de.ityx.response.it.docker.util.DockerPrint.printImage;
import static de.ityx.response.it.docker.util.DockerPrint.printImageTags;
import static de.ityx.response.it.docker.util.DockerPrint.printImages;
