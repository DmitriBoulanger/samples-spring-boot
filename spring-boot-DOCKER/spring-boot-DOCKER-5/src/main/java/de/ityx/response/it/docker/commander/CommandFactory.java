...
public class CommandFactory implements DockerCmdExecFactory {
    ...
    @Override
    public void init(final DockerClientConfig dockerClientConfig) {
    ...
    public CreateContainerCmd.Exec createCreateContainerCmdExec() {
        return new CreateContainerCmd.Exec() {
            @Override
            public CreateContainerResponse exec(final CreateContainerCmd command) {
                final CreateContainerResponse createContainerResponse = delegate.createCreateContainerCmdExec().exec(command);
    ...
    public RemoveContainerCmd.Exec createRemoveContainerCmdExec() {
        return new RemoveContainerCmd.Exec() {
            @Override
            public Void exec(final RemoveContainerCmd command) {
    ...
    public CreateImageCmd.Exec createCreateImageCmdExec() {
        return new CreateImageCmd.Exec() {
            @Override
            public CreateImageResponse exec(final CreateImageCmd command) {
                final CreateImageResponse createImageResponse = delegate.createCreateImageCmdExec().exec(command);
    ...
    public LoadImageCmd.Exec createLoadImageCmdExec() {
        return new LoadImageCmd.Exec() {
            @Override
            public Void exec(final LoadImageCmd command) {
    ...
    public RemoveImageCmd.Exec createRemoveImageCmdExec() {
        return new RemoveImageCmd.Exec() {
            @Override
            public Void exec(final RemoveImageCmd command) {
    ...
    public BuildImageCmd.Exec createBuildImageCmdExec() {
        return new BuildImageCmd.Exec() {
            @Override
            public Void exec(final BuildImageCmd command, final ResultCallback<BuildResponseItem> resultCallback) {
    ...
    public CreateVolumeCmd.Exec createCreateVolumeCmdExec() {
        return new CreateVolumeCmd.Exec() {
            @Override
            public CreateVolumeResponse exec(final CreateVolumeCmd command) {
                final CreateVolumeResponse result = delegate.createCreateVolumeCmdExec().exec(command);
    ...
    public RemoveVolumeCmd.Exec createRemoveVolumeCmdExec() {
        return new RemoveVolumeCmd.Exec() {
            @Override
            public Void exec(final RemoveVolumeCmd command) {
    ...
    public CreateNetworkCmd.Exec createCreateNetworkCmdExec() {
        ...
        return new CreateNetworkCmd.Exec() {
            @Override
            public CreateNetworkResponse exec(final CreateNetworkCmd command) {
                final CreateNetworkResponse result = delegate.createCreateNetworkCmdExec().exec(command);
    ...
    public RemoveNetworkCmd.Exec createRemoveNetworkCmdExec() {
        return new RemoveNetworkCmd.Exec() {
            @Override
            public Void exec(final RemoveNetworkCmd command) {
