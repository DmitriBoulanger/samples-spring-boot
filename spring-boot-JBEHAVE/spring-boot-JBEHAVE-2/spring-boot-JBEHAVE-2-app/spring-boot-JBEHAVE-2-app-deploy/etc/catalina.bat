...
set "ITYX_CONF=D:\contex-license\git\license\license-test\conf"
set "MYSQL_URL=jdbc:mysql://localhost:3306/"
set "MYSQL_ROOT=root"
set "MYSQL_PASSWORD=ityx"

rem ----- Special Application System Properties ------------------------------

set "JAVA_OPTS=%JAVA_OPTS% -Dityx.conf=%ITYX_CONF%" 
