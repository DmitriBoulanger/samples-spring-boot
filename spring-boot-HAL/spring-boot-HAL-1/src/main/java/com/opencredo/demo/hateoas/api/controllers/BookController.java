...
import com.opencredo.demo.hateoas.api.resources.newinrequest.BookNew;
...
//   }
   ...
   public ResponseEntity<Void> newBook(@RequestBody BookNew newBookRequest) {
      // TODO Add input validation
      
      // Create or retrieve Authors
      final List<Author> authors = new ArrayList<>();
      for(BookNew.Author authorRequest : newBookRequest.getAuthors()) {
   ...
   private Author createOrRetrieveAuthor(BookNew.Author newAuthorRequest) {
